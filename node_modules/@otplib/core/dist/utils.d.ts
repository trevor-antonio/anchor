...
import { HashAlgorithm, SecretOptions, OTPResult } from './types.js';
 ...
 */
declare const HASH_ALGORITHMS: readonly ("sha1" | "sha256" | "sha512")[];
/**
 ...
 * ```
 */
declare function normalizeHashAlgorithm(value: unknown, options?: NormalizeHashAlgorithmOptions): HashAlgorithm;
/**
 * Validate secret key
 *
