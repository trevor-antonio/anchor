...
const mapJWSAlgToCOSEAlg_js_1 = require("../helpers/mapJWSAlgToCOSEAlg.js");
...
function verifyJWT(jwt, leafCert) {
    ...
    const headerJSON = JSON.parse(index_js_1.isoBase64URL.toUTF8String(header));
    const jwtHeaderHashAlgCOSE = (0, mapJWSAlgToCOSEAlg_js_1.mapJWSAlgToCOSEAlg)(headerJSON.alg);
